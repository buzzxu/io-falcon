...
import io.falcon.client.SafeParameter;
import io.falcon.client.Upload;
import io.falcon.servlet.multi.MultiMap;
import io.falcon.servlet.multi.MultiPartInputStreamParser;
import io.falcon.servlet.multi.UrlEncoded;
 ...
 */
public class Request extends HttpServletRequestWrapper implements Closeable {
     ...
     */
    public  Request(HttpServletRequest request, MultipartConfigElement config) {
        super(request);
    ...
    private SafeParameter getSafeParameter() {
        ...
        safeParameter = Falcon.instance.instance(SafeParameter.class);
