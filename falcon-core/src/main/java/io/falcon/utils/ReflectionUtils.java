...
public abstract class ReflectionUtils {
     ...
     * twice, unless excluded by a {@link io.falcon.utils.ReflectionUtils.MethodFilter}.
     * @param clazz class to start looking at
     * @param mc the callback to invoke for each method
     * @see #doWithMethods(Class, io.falcon.utils.ReflectionUtils.MethodCallback, io.falcon.utils.ReflectionUtils.MethodFilter)
     */
     ...
     * <p>The same named method occurring on subclass and superclass will appear
     * twice, unless excluded by the specified {@link io.falcon.utils.ReflectionUtils.MethodFilter}.
     * @param clazz class to start looking at
     * @param mc the callback to invoke for each method
...
//         }
    ...
    public static String getDesc(Class clazz) {
        ...
        if (clazz.isArray()) {
            ret.append('[');
            ret.append(getDesc(clazz.getComponentType()));
